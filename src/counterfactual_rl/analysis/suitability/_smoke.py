...
Asserts:
  1. env: slip_prob=0.0 matches is_slippery=False; slip_prob=2/3 matches is_slippery=True.
...
def check_env():
    ...
    p0 = FrozenLakeEnv(map_name="4x4", slip_prob=0.0)
    p23 = FrozenLakeEnv(map_name="4x4", slip_prob=2 / 3)
    ...
    print("[1/4] env slip_prob check OK")
