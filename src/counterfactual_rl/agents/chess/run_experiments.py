"""Submit Chess experiment sweeps to SLURM and save manifest files.

Usage:
    python run_experiments.py smoke_test --dry-run
...
# Phase 1: pilot — establishes Gardner Chess threshold
PILOT = {
    'name': 'pilot',
...
def submit_experiment(experiment_name, dry_run=False):
    ...
    script_path = os.path.join(script_dir, 'train_chess.sh')
